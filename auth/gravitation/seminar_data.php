<?php
include('../config.php');
$query = mysqli_query($conn, "SELECT * FROM register_seminar WHERE level != 'admin'");
    ...
    <header id="header" class="header fixed-top">
        ...
        ">
            <a href="#" class="logo d-flex align-items-center">
                <img src="../../assets/img/geosentric/GRAVITATION.png" alt="" />
                <span>Seminar Admin</span>
            </a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['institution_origin']; ?></td>
